...
[![hexlet-check](https://github.com/A-Brusnitsyn/java-project-61/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/A-Brusnitsyn/java-project-61/actions)
...
```bash
git clone https://github.com/A-Brusnitsyn/java-project-61.git
cd java-project-61
```
